            ...
            <div class="col-12 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <h5>Manage Cause</h5>
                        <hr>
                        <form method="POST" action="{{ route('cause.update', $cause->uuid) }}" aria-label="{{ __('new-slider') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        @foreach($cause->uploads as $image)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <input id="" type="text" class="form-control" required name="title" placeholder="Cause Title (recomemded)" value="{{ $cause->title }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <input id="" type="text" class="form-control " name="small_title" placeholder="Extra Cause Title" value="{{ $cause->small_title }}" autocomplete="off" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <input id="" type="text" class="form-control" required name="goal" placeholder="Cause Goal (recomemded)" value="{{ $cause->goal }}" autocomplete="off" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <input id="" type="text" class="form-control" name="tags" placeholder="Cause Tags, use example: #child #hunger #school..." value="{{ $cause->tags }}" autocomplete="off" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <input id="" type="text" class="form-control" name="location" placeholder="Location Name" value="{{ $cause->location }}" autocomplete="off" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <select name="featured" id="" class="form-control">
                                        <option value="no" {{ $cause->featured==='no'?'selected':'' }}>No</option>
                                        <option value="yes" {{ $cause->featured==='yes'?'selected':'' }}>Yes</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 ">
                                    <textarea id="" type="text" class="form-control" name="intro" required placeholder="Introduction (keep it short)">{{ $cause->intro }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea id="" type="text" rows="20" class="form-control myfield" name="info" placeholder="Extra Slider Information">{{ $cause->info }}</textarea>
                                </div>
                            </div>
...
@section('more_js')
    ...
    <script type="text/javascript">
        ...
        let md = new Dropzone("#dropzone", {
            url: '{{ route('uploadImage', $cause->uuid) }}',
            maxFilesize: 1,
            ...
            removedfile: function(file) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '{{ route("deleteImage", $cause->uuid) }}',
                    data: {filename: name},
