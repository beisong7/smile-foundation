                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('slider.store') }}" aria-label="{{ __('new-slider') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" autocomplete="off" name="button_url" value="{{ old('button_url') }}" class="form-control" placeholder="Example: http://weavonhair.com/products">
                                </div>
                            </div>
...
@section('other_js')
    ...
    <script type="text/javascript">
        ...
        let md = new Dropzone("#dropzone", {
            url: '{{ route('uploadSlider', !empty($unid)?$unid:old('unid')) }}',
            maxFilesize: 1,
            ...
            removedfile: function(file) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '{{ route("sliderDelete", !empty($unid)?$unid:old('unid')) }}',
                    data: {filename: name},
